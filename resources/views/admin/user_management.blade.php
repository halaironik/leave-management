        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">    
                    ...
                    <a href="{{ route('admin.user.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 mb-4 inline-block">Add New User</a>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border-b">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('admin.user.edit', $user->id) }}" class="bg-yellow-500 text-white px-2 py-1 rounded-md hover:bg-yellow-600">Edit</a>
                                        <form action="{{ route('admin.user.destroy', $user->id) }}" method="POST" onsubmit="return confirmDelete()">
                                            @csrf
                                            @method('DELETE')
                                            <x-danger-button class="bg-red-500 text-white px-2 py-1 rounded-md hover:bg-red-600">Delete</x-danger-button>
                                        </form>
                                        </div>
                                    </td>
                                </tr>
